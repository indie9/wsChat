<template>
  <div class="bg-white rounded-lg shadow-lg p-4 w-96 flex flex-row">
    ...
    <button v-if="!isMaster" @click="editUser"
      class="hover:text-gray-800 text-gray-500 font-bold h-8 w-8 ml-auto">
    ...
    <button v-if="!isMaster" @click="deleteUser" class=" hover:text-red-800 text-red-500 font-bold h-8 w-8 ml-2">
